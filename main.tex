...
\logoright{\includegraphics[height=8cm]{logos/qrcode.png}}
\logoleft{\includegraphics[height=8cm]{logos/snu_logo.png}}
...
\footercontent{
	ABC Conference 2025, Bourg Palette, Kanto \hfill
	\insertdate \hfill
